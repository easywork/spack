...
if [ $# -ne 3 ]
    then echo "usage: vmsupport-pktcap-dst.sh vm_name ip dst_port"
    exit
fi
...
pktcap-uw --switchport $switchport --dir=1 --stage=0 --ip $ip --tcpport $port -o $kpath/vds_d1s0.pcap &
PID1="$!"

### After DFW
# pktcap-uw --switchport 83886242 --dir=0 --stage=1 --srcport 1023 --count 4 -o - | tcpdump-uw -enr -
pktcap-uw --switchport $switchport --dir=1 --stage=1 --ip $ip --tcpport $port -o $kpath/vds_d1s1.pcap &
PID2="$!"

### uplink before IOchain
# pktcap-uw --uplink vmnic3 --dir=1 --stage=0 --srcip 192.168.61.33 --srcport 1023 --count 4 -o - | tcpdump-uw -enr -
pktcap-uw --uplink $nic --dir=0 --stage=0 -o $kpath/nic_d0s0.pcap &
PID3="$!"

### uplink after IOchain
# pktcap-uw --uplink $vmnic3 --dir=1 --stage=1 --srcip 192.168.61.33 --srcport 1023 --count 4 -o - | tcpdump-uw -enr -
pktcap-uw --uplink $nic --dir=0 --stage=1 --ip $ip -o $kpath/nic_d0s1.pcap &
PID4="$!"
